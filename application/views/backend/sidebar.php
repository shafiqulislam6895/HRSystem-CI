            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-star-circle"></i><span class="hide-menu">HR Analytics</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>skillgap">Skill Gap Analysis</a></li>
                                <li><a href="<?php echo base_url(); ?>gamification">Gamification</a></li>
                            </ul>
                        </li>
